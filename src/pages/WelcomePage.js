...
class WelcomePage extends React.Component {
  render() {
    return (
      <div>
        <Navbar
          style={{ marginTop: -10, paddingLeft: 80, paddingRight: 150 }}
          className="d-flex"
          light
          expand="md"
        >
          <NavbarBrand className="d-flex" href="/mainpage">
            Todo-Apps
          </NavbarBrand>
          <Link to="/login">
            <NavbarText style={{ marginTop: 30 }} className="have-account">
        ...
        <Container className="card-group container-fluid">
          <Card>
            <div className="welcome">
              <img
                className="set-image"
                src={require("../styles/images/To do list-pana.svg")}
                alt="pic" 
              />
            </div>
          </Card>
          <Card className="landing-page-text">
            ...
            <p>
              ...
              nisi u t aliquip ex ea commodo consequat.
            </p>
